...
|---------|------|---------|
| 2.2.0 | Dec 13, 2024 | Enhanced auth (OAuth, role selection, certificates), Admin approvals, Email alerts |
| 2.1.0 | Nov 25, 2025 | UI/UX improvements, database setup, documentation |
| 2.0.0 | Original | Initial release |

---

## 🆕 Version 2.2.0 Changes (December 2024)
...
- ✅ Unified approval center (`/admin/approvals`)
- ✅ Role request management with document viewing
- ✅ Deduplication (same user won't appear multiple times)
- ✅ View doctor certificates in admin dashboard

### Email Notifications
- ✅ Resend API integration (replaced SMTP)
- ✅ Beautiful HTML email templates
- ✅ Emergency alerts to doctors/ASHA workers

### New API Endpoints
- ✅ `/auth/role-requests` - Role request management
- ✅ `/auth/upload-cert` - Doctor certificate upload
- ✅ `/admin/stats` - Dashboard statistics
- ✅ `/admin/mothers/{id}/send-alert` - Send email alerts

### Database Updates
- ✅ `registration_requests` table for role requests
- ✅ `degree_cert_url` column in `doctors` table
- ✅ Updated RLS policies

### Files Modified
- `frontend/src/pages/AuthCallback.jsx` - Role selection flow
- `frontend/src/pages/AdminApprovals.jsx` - Unified approval center
- `frontend/src/pages/AdminDashboard.jsx` - View doctor certificates
- `frontend/src/services/api.js` - New API functions
- `backend/routes/auth_routes.py` - Role request endpoints
- `backend/routes/admin_routes.py` - Admin management endpoints
- `backend/services/email_service.py` - Resend email integration
- `infra/supabase/schema.sql` - New tables and policies
