...
export default function AuthCallback() {
  ...
  useEffect(() => {
    ...
    if (error) {
      ...
      setOauthError({
        code: error,
        message: decodeURIComponent(errorDescription || 'Authentication failed')
      })
      setStage('error')
      return
    }
  ...
  const handleSubmitRole = async (role, file) => {
    ...
    try {
      ...
      if (file && role === 'DOCTOR') {
        const fileName = `doctor_registrations/${currentUser.id}/${Date.now()}_${file.name}`
        ...
        if (uploadError) {
          ...
          const { data: urlData } = supabase.storage.from('certifications').getPublicUrl(fileName)
        ...
        <div className="max-w-md w-full mx-4">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <p className="text-sm text-gray-500 mb-6">
              This usually happens when there's an issue with your account or the authentication service.
        ...
        <div className="max-w-lg w-full mx-4">
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-purple-600 mb-2">🤰 MatruRaksha AI</h1>
              ...
              {pendingEmail && (
                <p className="text-sm text-gray-500 mt-1">
                  Signed in as: <span className="font-medium">{pendingEmail}</span>
                </p>
              )}
            </div>
            ...
            <div className="space-y-4">
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-gray-900">I am a Doctor</h3>
                    <p className="text-sm text-gray-500">Medical practitioner overseeing maternal care</p>
                  </div>
                </div>
              </button>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-gray-900">I am an ASHA Worker</h3>
                    <p className="text-sm text-gray-500">Community health worker supporting mothers</p>
                  </div>
                </div>
              </button>
            </div>
        ...
        <div className="max-w-lg w-full mx-4">
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 mt-2">
                Please upload your medical registration document for verification
              </p>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <h4 className="font-semibold text-blue-800 mb-2">📋 Accepted Documents:</h4>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-yellow-100">
        <div className="max-w-md w-full mx-4">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-4">
              Your registration for <span className="font-semibold text-gray-800">{pendingEmail}</span> is pending admin approval.
            </p>
            <p className="text-sm text-gray-500 mb-6">
              {selectedRole === 'DOCTOR'
